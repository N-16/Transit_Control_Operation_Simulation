...
RL_TRANSIT_INFO = [{'id':1,'capacity':100, 'controllable':True,
                    'gamma': 0.99, 'epsilon':0.9, 'alpha':1e-5,
                    'batch_size': 256, 'eps_decay': 5e-5,
                    'replace': 100, 'input_dims':[22], 'n_actions':2,
                    'mem_size' : 100000, 'eps_min':0.1},
                {'id':2,'capacity':100, 'controllable':True,
                    'gamma': 0.99, 'epsilon':0.9, 'alpha':1e-5,
                    'batch_size': 256, 'eps_decay': 5e-5,
                    'replace': 100, 'input_dims':[22], 'n_actions':2,
